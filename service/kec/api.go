...
// ModifyInstanceChargeTypeRequest generates a "ksc/request.Request" representing the
...
//	}
//
// See also, https://docs.aws.amazon.com/goto/WebAPI/kec-2016-03-04/ModifyInstanceChargeType
func (c *Kec) ModifyInstanceChargeTypeRequest(input *map[string]interface{}) (req *request.Request, output *map[string]interface{}) {
	op := &request.Operation{
...
// ModifyInstanceChargeType API operation for kec.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
// the error.
...
// See also, https://docs.aws.amazon.com/goto/WebAPI/kec-2016-03-04/ModifyInstanceChargeType
func (c *Kec) ModifyInstanceChargeType(input *map[string]interface{}) (*map[string]interface{}, error) {
...
// sub-contexts for http.Requests. See https://golang.org/pkg/context/
// for more information on using Contexts.
func (c *Kec) ModifyInstanceChargeTypeWithContext(ctx aws.Context, input *map[string]interface{}, opts ...request.Option) (*map[string]interface{}, error) {
	req, out := c.ModifyInstanceChargeTypeRequest(input)
	req.SetContext(ctx)
	req.ApplyOptions(opts...)
	return out, req.Send()
